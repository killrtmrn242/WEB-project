document.addEventListener("DOMContentLoaded", function () { 
    ...
    document.getElementById('changeBackgroundBtn').addEventListener('click', () => {
        document.body.style.backgroundColor = isWhiteBackground ? 'grey' : 'white';
        document.body.style.color = isWhiteBackground ? 'white' : 'grey';
        isWhiteBackground = !isWhiteBackground;
        localStorage.setItem("backgroundColor", isWhiteBackground ? "white" : "grey"); // Сохранение цвета фона
    });
