...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const mobileCartDetails = document.getElementById('mobileCartDetails');
    ...
    function updateCart() {
        ...
        cart.forEach(item => {
            ...
            mobileCartList.appendChild(cartItem.cloneNode(true));
    ...
    // Обработчик для кнопки корзины на мобильной версии
    mobileCartButton.addEventListener('click', function () {
        mobileCartDetails.classList.toggle('open');
    });

    // Обработчик для кнопок "To Cart"
